...
class CompanyViewModel(BaseViewModel):
    ...
    def __init__(
        ...
        self._division_service = division_service
    ...
    def init_model_data(self) -> None:
        ...
        self.load_all_divisions(self.current_company)
    ...
    def current_company(self, company: CompanyDomain | None) -> None:
        self._current_company = company if company else None
        self.company_data_changed_signal.emit()
    ...
    def current_division(self, division: DivisionDomain | None) -> None:
        if division:
            ...
            self.departments = division.departments
    ...
    def division_name_data(self) -> tuple[list[str], str]:
        ...
        if self.current_division:
            current_division_name = self.current_division.name
    ...
    def department_name_data(self) -> tuple[list[str], str]:
        ...
        if isinstance(self.current_department, DepartmentDomain):
            current_department_name = self.current_department.name
        return department_names, current_department_name

    def load_all_companies(self):
        companies = self._company_service.load_all_companies()
