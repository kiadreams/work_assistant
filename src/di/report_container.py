...
class DivisionDialogContainer(containers.DeclarativeContainer):
    ...
    company_viewmodel: providers.Dependency[CompanyViewModel] = providers.Dependency()

    division_validator = providers.Factory(DivisionValidator, company_service=company_service)
    division_mapper_service = providers.Factory(DivisionMapperService)

    department_validator = providers.Factory(DepartmentValidator, company_service=company_service)
    ...
    edit_division_dialog_model = providers.Factory(
        ...
        current_division=providers.AttributeGetter(company_viewmodel, "current_division"),
    )
    ...
    edit_department_dialog_model = providers.Factory(
        ...
        current_department=providers.AttributeGetter(company_viewmodel, "current_department"),
    )
